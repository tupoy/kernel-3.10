...
static void GC2035_Sensor_Init(void)
{
	...
	GC2035_write_cmos_sensor(0xfe , 0x00);//G
	GC2035_write_cmos_sensor(0xad , 0x80);//r gain
	GC2035_write_cmos_sensor(0xae , 0x7a);//g gain 
	GC2035_write_cmos_sensor(0xaf , 0x78);//b gain
	GC2035_write_cmos_sensor(0xfe , 0x01);
  /////////awb end /////////////
	//AEC
	GC2035_write_cmos_sensor(0xfe , 0x01);
	GC2035_write_cmos_sensor(0x11 , 0x20);//AEC_out_slope , 0x
	GC2035_write_cmos_sensor(0x1f , 0xa0);//max_post_gain   //by Jason.
	GC2035_write_cmos_sensor(0x20 , 0x50);//max_pre_gain   //by Jason.
	GC2035_write_cmos_sensor(0x47 , 0x30);//AEC_outdoor_th   
	GC2035_write_cmos_sensor(0x0b , 0x10);//
	GC2035_write_cmos_sensor(0x13 , 0x90);//y_target
	...
	GC2035_write_cmos_sensor(0x29,  0x04);//522
	GC2035_write_cmos_sensor(0x2a,  0x90);  
	GC2035_write_cmos_sensor(0x2b,  0x05);//5b4
	GC2035_write_cmos_sensor(0x2c,  0x22);  
	GC2035_write_cmos_sensor(0x2d,  0x05);//5b4
	GC2035_write_cmos_sensor(0x2e,  0x22);  
	GC2035_write_cmos_sensor(0x2f,  0x05);//76a
	GC2035_write_cmos_sensor(0x30,  0xb4);  
	GC2035_write_cmos_sensor(0xfe , 0x00);  //
	...
	GC2035_write_cmos_sensor(0x84 , 0x03); //output put foramat  //by Jason.//00 cyrille
	GC2035_write_cmos_sensor(0x86 , 0x06); //02 //sync plority// cyrille 
					  ...
					  MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
    	...
    	if(GC2035_sensor_cap_state == KAL_FALSE)
	  {
		...
		//GC2035_DELAY_AFTER_PREVIEW = 1;  // 4_dj
		memcpy(&GC2035SensorConfigData, sensor_config_data, sizeof(MSDK_SENSOR_CONFIG_STRUCT));
		return ERROR_NONE;
}	/* GC2035Capture() */
					  ...
					  MSDK_SENSOR_CONFIG_STRUCT *pSensorConfigData)
{
	...
	pSensorInfo->CaptureDelayFrame = 1; // 4_dj
...
BOOL GC2035_set_param_banding(UINT16 para)
{
    ...
    switch (para)
    {
		...
		GC2035_write_cmos_sensor(0x27, 0x00);//
		GC2035_write_cmos_sensor(0x28, 0x92);  
		GC2035_write_cmos_sensor(0x29, 0x04);//11fps
		GC2035_write_cmos_sensor(0x2a, 0x90);  
		GC2035_write_cmos_sensor(0x2b, 0x05);//10fps
		GC2035_write_cmos_sensor(0x2c, 0x22);  
		GC2035_write_cmos_sensor(0x2d, 0x05);//10fps
		GC2035_write_cmos_sensor(0x2e, 0x22);  
		GC2035_write_cmos_sensor(0x2f, 0x05);//7.7fps  76a_dj
		GC2035_write_cmos_sensor(0x30, 0xb4);  
		GC2035_write_cmos_sensor(0xfe, 0x00);  
            break;
