...
#endif
#if defined(GC0313_YUV)	
    {GC0313_SENSOR_ID,SENSOR_DRVNAME_GC0313_YUV, GC0313_YUV_SensorInit},
#endif
/*SP*/
...
#endif
#if defined(SIV122DU_YUV)
    {SIV122DU_SENSOR_ID, SENSOR_DRVNAME_SIV122DU_YUV, SIV122DU_YUV_SensorInit},
#endif
/*PAS (PixArt Image)*/
